...
# /home/ubuntu/FlaskProject/pybo/uploads
# 파일 업로드 처리
...
def upload_file():
    if request.method == 'POST':
        ...
        f.save("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + '.csv')
        # fff = pd.read_csv("C:/finalproject/myproject/pybo/uploads/" + obj + '.csv', encoding='CP949')
        fff = pd.read_csv("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + '.csv')
        # return f.to_html()
        df_info = fff
        df_col = []
...
def to_json():
        obj = g.user.username
        df_info = pd.read_csv("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + ".csv")
        df_col = []
        ...
        with open("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + ".json", 'w') as f:
            json.dump(to_json, f)
...
def to_json_part2():
    ...
    df_info.to_csv("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + '.csv')
    df_info2 = pd.read_csv("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + '.csv')
    df_info2 = df_info2.iloc[:,1:]
    df_info2.to_csv("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + '.csv')
    df_col2 = []
...
def synth_generate():
        ...
        with open("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + ".json", 'r') as f:
            dtypes = json.load(f)
        columns = list(dtypes.keys())

        df = pd.read_csv("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + ".csv", header=None, skiprows = 1, names=columns).astype(dtypes)
        # 헤더가 있는 경우 -> skip
        df = df.iloc[:, 1:]
        ...
        synth_df.to_csv("/home/ubuntu/FlaskProject/pybo/synth_dir/" + obj + ".csv", index= False)
...
def partsynth_generate():
        ...
        result.to_csv("/home/ubuntu/FlaskProject/pybo/synth_dir/" + obj + ".csv", index= False)
...
def distribution():
    obj = g.user.username
    original_data = pd.read_csv("/home/ubuntu/FlaskProject/pybo/uploads/" + obj + ".csv")
    original_data = original_data.iloc[:,1:]
    synth_data = pd.read_csv("/home/ubuntu/FlaskProject/pybo/synth_dir/" + obj + ".csv")
    cate_col = []
    ...
    for i in range(0, cols):
        ...
        plt.savefig('/home/ubuntu/FlaskProject/pybo/static/img_dir/' + obj + 'dis.png')
...
def correlation():
    ...
    plt.savefig('/home/ubuntu/FlaskProject/pybo/static/img_dir/' + obj + 'origincorr.png')
    plt.close()
    ...
    plt.savefig('/home/ubuntu/FlaskProject/pybo/static/img_dir/' + obj + 'synthcorr.png')
    plt.close()
...
def hello_pybo3():
    ...
    file = "/home/ubuntu/FlaskProject/pybo/uploads/" + obj + ".csv"
    if os.path.isfile(file):
        os.remove(file)
    path = "/home/ubuntu/FlaskProject/pybo/synth_dir/" + obj + ".csv"
    file2 = "/home/ubuntu/FlaskProject/pybo/uploads/" + obj + ".json"
