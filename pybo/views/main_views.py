...
def synth_generate():
    ...
    df = pd.read_csv("/home/ubuntu/projects/FlaskProject/pybo/uploads/" + obj + ".csv", header=None, skiprows=1,
    ...
    return render_template('synth_generate.html', tables=[df2.to_html()], titles=[''], tables2=[synth_df2.to_html()],
                           titles2=[''])
